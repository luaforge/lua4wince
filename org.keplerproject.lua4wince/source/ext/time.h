/*
** Custom version - taken from Visual C++ 6.0
** To supplement WinCE defines - prototypes for new functions
** are in lwince.h
** Ian McIntosh, August 2008.
*/
...
/* _CRTIMP time_t __cdecl mktime(struct tm *); IAN */
