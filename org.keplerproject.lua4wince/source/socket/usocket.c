...
*
* RCS ID: $Id: usocket.c,v 1.1 2009-04-12 00:03:43 jasonsantos Exp $
\*=========================================================================*/
#include <string.h>
#include <signal.h>
...
int socket_gethostbyaddr(const char *addr, socklen_t len, struct hostent **hp) {
    *hp = gethostbyaddr(addr, len, AF_INET);
    ...
    /* else if (h_errno) return h_errno; */ /* JASON -- removendo h_errno */
...
/*        default: return hstrerror(err); */ /* JASON -- removendo hstrerror */
